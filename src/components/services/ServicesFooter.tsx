        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="space-y-6">
              <h2 className="text-lg sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight">
              ...
              <button className="bg-[#ff6b35] hover:bg-[#e55a2b] text-white px-8 py-4 rounded-lg text-xs sm:text-sm md:text-base font-semibold transition-colors">
                Get Started Today
              </button>
            </div>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold mb-4">Contact Information</h3>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <Phone className="w-5 h-5 text-[#ff6b35]" />
                    <span className="text-xs sm:text-sm md:text-base">+1 (555) 123-4567</span>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base">contact@ssadvisory.com</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-[#ff6b35]" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-xs sm:text-sm md:text-base">123 Business Ave, Suite 100<br />New York, NY 10001</span>
                  </div>
                </div>
              </div>

              <div>
                <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold mb-4">Our Services</h3>
      ...
      <footer className="bg-[#0a0f1a] text-gray-400 py-6">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs sm:text-sm md:text-base">&copy; 2024 SS Advisory. All rights reserved.</p>
