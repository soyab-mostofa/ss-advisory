...
const ValueCard: React.FC<ValueCardProps> = ({
  ...
  return (
    <div
      className={`bg-white border border-[#d4e4ff] rounded-xl overflow-hidden max-w-[300px] md:max-w-[379px] h-64  md:h-[280px] ${className}`}
    >
      ...
      <div className="relative bg-[#eef8ff] p-6 flex flex-col gap-[10px]">
        ...
        <div className="absolute bottom-0 right-0 w-[60px] h-[60px] transform rotate-180">
          <ImageRevealAnimation
            src="/images/services/values/decorative-vector.svg"
            alt=""
